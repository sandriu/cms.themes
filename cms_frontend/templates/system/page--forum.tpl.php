...
<header id="navbar" role="banner" class="navbar-default">
  ...
  <div class="container">
      <div class="row">   
        ...
        <div class="left-header col-md-7">     
        ...
        <div class="right-header col-md-5">
...
<div class="container">
  <div class="row">  
    ...
    <div class="region col-md-12 center-column">            
      ...
      <div style="float: right"><?php $block = module_invoke('menu_block','block_view','4'); print render($block['content']); ?></div>
      <?php endif; ?>
