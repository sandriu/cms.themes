...
<div id="forum-statistics" class="panel panel-default">
  <div id="forum-statistics-header" class="panel-heading"><?php print t("What's Going On?"); ?></div>
  ...
  <?php if (!empty($online_users)) : ?>
    <div id="forum-statistics-active-body" class="forum-statistics-sub-body panel-heading">
  ...
  <div id="forum-statistics-statistics-body" class="forum-statistics-sub-body panel-heading">
