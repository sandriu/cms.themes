...
?>
<table border="0" cellpadding="0" cellspacing="0" width="600" bgcolor="#EEEEEE">
  <tbody>
    <?php if (!$opt_out_hidden): ?>
      <tr style="font-size: 11px; color: #555555; font-family: Arial, sans-serif;">
        <td colspan="2" style="border-bottom: 1px solid #dddddd; padding-top: 10px; padding-bottom: 10px; padding-left: 20px; padding-right: 20px;">
      ...
      <tr style="font-size: 11px; color: #555555; font-family: Arial, sans-serif;">
        <td style="width: 470px; padding-top: 10px; padding-bottom: 10px; padding-left: 20px; padding-right: 20px; line-height: 1.4;">
          <p><?php echo t('This newsletter is published by the CMS Secretariat &copy; 2014 UNEP / CMS'); ?></p>
          <p><?php echo t('UNEP/CMS Secretariat, Platz der Vereinten Nationen 1, 53113 Bonn, Germany'); ?></p>
          <p><?php echo t('Tel: (+49) 228 815 2413, Fax: (+49) 228 815 2450, E-mail: secretariat@cms.int'); ?></p>
          <p><a href="<?php echo t('http://www.cms.int/'); ?>" style="color: #0066c0;"><?php echo t('www.cms.int'); ?></a>&nbsp;&nbsp;<a href="<?php echo t('http://www.unep.org/'); ?>" style="color: #0066c0;"><?php echo t('www.unep.org'); ?></a></p>
        </td>
