<button type="button" class="btn btn-info btn-mini" data-toggle="collapse" data-target="#status-legend">
    <?php
...
<div id="status-legend" class="collapse out">
    <table class="table table-bordered">
        <thead>
            <tr>
                <th colspan="3" class="span2"><?php echo t('Column'); ?> A</th>
            </tr>
        </thead>

        <tbody>
            <tr>
                <td rowspan="3" class="span2"><?php echo t('Category'); ?> 1</td>
                <td>(a)</td>
            ...
            <tr>
                <td class="span2"><?php echo t('Category'); ?> 4</td>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <tr>
                <td class="span2"><?php echo t('Category'); ?> 1</td>
            ...
            <tr>
                <td rowspan="5" class="span2"><?php echo t('Category'); ?> 2</td>
                <td colspan="2">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <tr>
                <td class="span2"><?php echo t('Column'); ?> 1</td>
